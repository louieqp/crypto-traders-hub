...
class BitgetWsClient:
    ...
    def subscribe(self, channels, listener=None):
        ...
        for channel in channels:
            self.__all_subscribed.add(channel)
    ...
    def unsubscribe(self, channels):
        try:
            ...
            for channel in channels:
                if chanel in self.__all_subscribed:
                    self.__all_subscribed.remove(channel)
    ...
    def __on_close(self, ws, close_status_code, close_msg):
        print("ws is closing ...... close_status:{}, close_msg:{}".format(close_status_code, close_msg))
        self.__close()
        if not self.__reconnect_status:
            self.__re_connect()
    ...
    def __re_connect(self):
        ...
        print("reconnecting ...")
        self.build()
        self.subscribe(self.__all_subscribed)
        pass
